...
// ACCUWEATHER API KEY
var ACCUWEATHER_API_KEY = "jx2CK8FaApRyZz3zZ7Ap0WwQOjlzCpTA";
module.exports = {
...
},{"core-js/fn/regexp/escape":4,"core-js/shim":332,"regenerator-runtime/runtime":3}],3:[function(require,module,exports){
(function (global){(function (){
/**
...
},{"./_export":36,"./_fails":38,"./_string-at":109}],317:[function(require,module,exports){
'use strict';
...
},{"timers":334}],336:[function(require,module,exports){
"use strict";
...
var _require = require("../scripts/vue.js"),
    vue_name = _require.vue_name,
    vue_condition = _require.vue_condition,
    vue_temp = _require.vue_temp;

var _require2 = require("../scripts/forecast.js"),
    getCity = _require2.getCity,
    getWeather = _require2.getWeather;

var cityForm = document.querySelector("form.change-location");
var card = document.querySelector(".card");
var timeimg = document.querySelector(".card img");
var iconimg = document.querySelector(".icon img");
var alertbox = document.querySelector(".alert .closebtn");

var updateUI = function updateUI(data) {
  var citytime = data.infos.IsDayTime ? "day" : "night";
  var cityicons = data.infos.WeatherIcon;
  var cityname = data.location.EnglishName;
  var citycondition = data.infos.WeatherText;
  var citytemperature = data.infos.Temperature.Metric.Value; // remove alert if exists

  alertbox.parentElement.classList.add("d-none"); // update image

  timeimg.src = "../asset/".concat(citytime, ".svg"); // update icon

  iconimg.src = "../asset/icons/".concat(cityicons, ".svg"); // update cityname

  vue_name.updateData(cityname); // update citycondition

  vue_condition.updateData(citycondition); // update citytemp

  vue_temp.updateData(citytemperature); // show the results

  card.classList.remove("d-none");
};

var updateCity = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(cityname) {
    var location, infos;
...
cityForm.addEventListener("submit", function (event) {
  ...
  event.preventDefault(); // get city value
...
alertbox.addEventListener("click", function (event) {
  // prevent default action
  event.preventDefault(); // close alert

  alertbox.parentElement.classList.add("d-none");
});

},{"../scripts/forecast.js":337,"../scripts/vue.js":338}],337:[function(require,module,exports){
"use strict";
...
var config = require("../config.js"); //temp key


var key = config.ACCUWEATHER_API_KEY; // get city id

var getCity = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(city) {
    var url, params, query, response, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = "http://dataservice.accuweather.com/currentconditions/v1/".concat(locationId);
            params = {
              apikey: key,
              language: "en-us",
              details: false
...
},{"../config.js":1,"babel-polyfill":2}],338:[function(require,module,exports){
"use strict";
...
module.exports = {
  vue_name: vue_name,
  vue_condition: vue_condition,
  vue_temp: vue_temp
};

},{"vue/dist/vue.js":335}]},{},[336]);
